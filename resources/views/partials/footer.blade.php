<footer>
    <div class="container px-2 mx-auto py-4 flex flex-wrap divide-x divide-gray-700 dark:divide-white text-center gap-3 text-xs md:text-sm lg:text-sm xl:text-base">
        ...
        <div class="flex-grow">
            ...
            <div class="container flex flex-col px-2 mx-auto gap-3 ml-4">
                ...
                <div class="flex flex-row gap-3">
                    <!-- image -->
                    <div>
                        <svg class="w-8" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 382 382" style="enable-background:new 0 0 382 382;" xml:space="preserve">
                ...
                <div class="flex flex-row gap-3">
                    <!-- image -->
                    <div>
                        <svg class="w-8" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                ...
                <div class="flex flex-row gap-3">
                    ...
                    <!-- link -->
                    <div>
                        <a href="https://api.whatsapp.com/send?phone=527713004765" target="_blank">WhatsApp</a>
                    </div>
                    <!-- end link -->
                </div>                       
                <!-- end Whatsapp button -->
        ...
        <div class="flex-grow">
            ...
            <div><span>Design and develop by Mario Oviedo with Laravel 8 and TailWindCSS. 2021</span></div>
            <div>Linkedin and GitHub icons designed by <a href="https://www.freepik.com" title="Freepik">Freepik</a> and <a href="https://www.flaticon.es/autores/pixel-perfect" title="Pixel perfect">Pixel perfect</a> from <a href="https://www.flaticon.es/" title="Flaticon">www.flaticon.es</a></div>
        </div>
        <!-- end About zone -->
    </div>
</footer>